...
const StolenNecroCode_1 = require("./StolenNecroCode");
const Traders_1 = require("C:/snapshot/project/obj/models/enums/Traders");
const ConfigJson = __importStar(require("../config/config.json"));
const GoblinKingJson = __importStar(require("../db/GoblinKing.json"));
...
class GoblinKing {
    ...
    preAkiLoad(container) {
        ...
        container.register("StolenNecroCode", StolenNecroCode_1.StolenNecroCode, { lifecycle: tsyringe_1.Lifecycle.Singleton });
        //
        ...
        Traders_1.Traders[GoblinKingJson._id] = GoblinKingJson._id;
    ...
    postDBLoad(container) {
        ...
        this.logger.log(`[${this.modName}] Goblin King Active`, LogTextColor_1.LogTextColor.GREEN);
        this.logger.log(`[${this.modName}] Necromancy Successful, StolenNecroCode based on JuseNUCore`, LogTextColor_1.LogTextColor.GREEN);
        this.logger.log(`[${this.modName}] Please report bugs in the mod's comments or support thread.`, LogTextColor_1.LogTextColor.GREEN);
        this.logger.log(`[${this.modName}] Special thanks to Dirtbikercj for updating the QuestAPI`, LogTextColor_1.LogTextColor.GREEN);
        this.logger.log(`[${this.modName}] Pour one for the dead homies`, LogTextColor_1.LogTextColor.GREEN);
    }
    ...
    registerStaticRouter(container) {
        const staticRouterModService = container.resolve("StaticRouterModService");
        staticRouterModService.registerStaticRouter("GoblinKingUpdateLogin", [
            {
        ...
        staticRouterModService.registerStaticRouter("GoblinKingUpdate", [
            {
    ...
    addSingleItemToAssortWithBarterScheme(assortTable, itemTpl, unlimitedCount, stackCount, loyaltyLevel, barterSchemes) {
        const newItem = {
            _id: itemTpl,
            _tpl: itemTpl,
            parentId: "hideout",
    ...
    addCollectionToAssort(assortTable, items, unlimitedCount, stackCount, loyaltyLevel, currencyType, currencyValue) {
        const collectionToAdd = JSON.parse(JSON.stringify(items));
    ...
    createAssortTable(container, sessionId) {
        ...
        const singleItemBarterSchemes = [
            { itemTpl: xtg12_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 20000 },
            { itemTpl: obdolbos_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 50000 },
            { itemTpl: meldonin_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 75000 },
            { itemTpl: zagustin_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 3, currencyType: Money_1.Money.ROUBLES, currencyValue: 150000 },
            { itemTpl: etg_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 3, currencyType: Money_1.Money.ROUBLES, currencyValue: 100000 },
            { itemTpl: l1_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 3, currencyType: Money_1.Money.ROUBLES, currencyValue: 100000 },
            { itemTpl: SURV12_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 3, currencyType: Money_1.Money.ROUBLES, currencyValue: 50000 },
            { itemTpl: CALOK_ID, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 3, currencyType: Money_1.Money.ROUBLES, currencyValue: 17500 },
            { itemTpl: goldstar_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 3, currencyType: Money_1.Money.ROUBLES, currencyValue: 17500 },
            { itemTpl: vaseline_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 11000 },
            { itemTpl: alumsplint_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 11000 },
            { itemTpl: CAT_ID, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 15000 },
            { itemTpl: IFAK_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 15000 },
            { itemTpl: sj9_id, unlimitedCount: false, stackCount: 5, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 125000 },
            { itemTpl: sj6_id, unlimitedCount: false, stackCount: 5, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 125000 },
            { itemTpl: sj1_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 125000 },
            { itemTpl: adrenaline_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 70000 },
            { itemTpl: propital_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 4, currencyType: Money_1.Money.ROUBLES, currencyValue: 125000 },
            { itemTpl: p22_id, unlimitedCount: false, stackCount: 5, loyaltyLevel: 4, currencyType: Money_1.Money.ROUBLES, currencyValue: 125000 },
            { itemTpl: mule_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 100000 },
            { itemTpl: ahf1m_id, unlimitedCount: false, stackCount: 10, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 90000 },
            { itemTpl: btg_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 3, currencyType: Money_1.Money.ROUBLES, currencyValue: 100000 },
            { itemTpl: MILK_ID, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 12500 },
            { itemTpl: morphine_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 2, currencyType: Money_1.Money.ROUBLES, currencyValue: 75000 },
            { itemTpl: esmarch_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 10000 },
            { itemTpl: advil_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 25000 },
            { itemTpl: band_aid_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 7500 },
            { itemTpl: splint_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 8500 },
            { itemTpl: cms_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 24500 },
            { itemTpl: car_first_aid_id, unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 20000 },
            ...
            { itemTpl: SICCP_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 1, currencyType: Money_1.Money.EUROS, currencyValue: 6000 },
            { itemTpl: THWEAPON_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 1, currencyType: Money_1.Money.EUROS, currencyValue: 25000 },
            { itemTpl: WEAPONCASE_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 1100000 },
            { itemTpl: THITEMCASE_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 1, currencyType: Money_1.Money.DOLLARS, currencyValue: 40000 },
            { itemTpl: CASEITEM_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 1, currencyType: Money_1.Money.DOLLARS, currencyValue: 15000 },
            { itemTpl: MEDCASE_ID, unlimitedCount: false, stackCount: 2, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 300000 },
            { itemTpl: MONEYCASE_ID, unlimitedCount: false, stackCount: 2, loyaltyLevel: 1, currencyType: Money_1.Money.DOLLARS, currencyValue: 2700 },
            { itemTpl: FOODCASE_ID, unlimitedCount: false, stackCount: 2, loyaltyLevel: 1, currencyType: Money_1.Money.ROUBLES, currencyValue: 320000 },
            { itemTpl: MAGBOX_ID, unlimitedCount: false, stackCount: 3, loyaltyLevel: 1, currencyType: Money_1.Money.EUROS, currencyValue: 2000 },
            { itemTpl: AMMOCASE_ID, unlimitedCount: false, stackCount: 4, loyaltyLevel: 1, currencyType: Money_1.Money.DOLLARS, currencyValue: 1500 },
            { itemTpl: PACA_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 2, currencyType: Money_1.Money.DOLLARS, currencyValue: 1000 },
            { itemTpl: patron_57x28_sb193_ID, unlimitedCount: true, stackCount: 1, loyaltyLevel: 2, currencyType: Money_1.Money.DOLLARS, currencyValue: 25 },
            { itemTpl: mag_57_fn_five_seven_std_57x28_20_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 2, currencyType: Money_1.Money.DOLLARS, currencyValue: 400 },
            { itemTpl: mag_p90_fn_p90_std_57x28_50_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 2, currencyType: Money_1.Money.DOLLARS, currencyValue: 500 },
            { itemTpl: helmet_armasight_nvg_googles_mask_ID, unlimitedCount: false, stackCount: 1, loyaltyLevel: 2, currencyType: Money_1.Money.DOLLARS, currencyValue: 300 },
            { itemTpl: "5c94bbff86f7747ee735c08f", unlimitedCount: true, stackCount: 999999999, loyaltyLevel: 3, currencyType: Money_1.Money.DOLLARS, currencyValue: 100 },
        ];
        singleItemBarterSchemes.forEach((singleItemBarterScheme) => this.addSingleItemToAssort(assortTable, singleItemBarterScheme.itemTpl, singleItemBarterScheme.unlimitedCount, singleItemBarterScheme.stackCount, singleItemBarterScheme.loyaltyLevel, singleItemBarterScheme.currencyType, singleItemBarterScheme.currencyValue));
        return assortTable;
    }
    getPresets(container, sessionId) {
        const assortTable = {
            nextResupply: 0,
            items: [],
            barter_scheme: {},
        ...
        const akiProfile = profileHelper.getFullProfile(sessionId);
        const pool = [];
        for (const weaponBuilds in akiProfile.weaponbuilds) {
            const weaponBuild = akiProfile.weaponbuilds[weaponBuilds];
            const preItems = weaponBuild.items;
            if (pool.includes(preItems[0]._id)) {
                continue;
            }
            pool.push(preItems[0]._id);
            const currency = ConfigJson.settings.PresetCurrency || Money_1.Money.DOLLARS;
    ...
    addTraderToDb(container) {
        const databaseServer = container.resolve("DatabaseServer");
        const databaseTables = databaseServer.getTables();
        databaseTables.traders[GoblinKingJson._id] = {
            assort: this.createAssortTable(container),
            base: JSON.parse(JSON.stringify({ ...GoblinKingJson, unlockedByDefault: !ConfigJson.settings.UnlockGoblinAfterCollector })),
    ...
    lockTraderBehindCollector(container) {
        const databaseServer = container.resolve("DatabaseServer");
        const databaseTables = databaseServer.getTables();
        const questCollector = databaseTables.templates.quests["5c51aac186f77432ea65c552"];
        questCollector.rewards.Success.push({
            _id: "",
            _tpl: "",
            id: `${GoblinKingJson._id}_UNLOCK`,
            type: QuestRewardType_1.QuestRewardType.TRADER_UNLOCK,
            index: 2,
        ...
        //       });
        //} 3000;
        this.logger.log(`[${this.modName}] Goblin will be unlocked after 'Collector'`, LogTextColor_1.LogTextColor.BLUE);
    }
    addTraderToLocales(container, fullName, firstName, nickName, location, description) {
        const databaseServer = container.resolve("DatabaseServer");
        const databaseTables = databaseServer.getTables();
        const locales = databaseTables.locales.global;
    ...
    addTraderToFleaMarket(container) {
        const configServer = container.resolve("ConfigServer");
    ...
    addItemsToDb(container) {
        const databaseServer = container.resolve("DatabaseServer");
        const databaseTables = databaseServer.getTables();
        if (ConfigJson.settings.RebalanceItemsForMoreRealism)
            this.rebalanceItemsForMoreRealism();
    ...
    rebalanceItemsForMoreRealism() {
        ...
        this.logger.log(`[${this.modName}] Items rebalanced for more realism`, LogTextColor_1.LogTextColor.BLUE);
    }
    addItemsToLocales(container) {
        const databaseServer = container.resolve("DatabaseServer");
        const databaseTables = databaseServer.getTables();
        const locales = databaseTables.locales.global;
        locales.en = {
    ...
    addHandbookToDb(container) {
        const databaseServer = container.resolve("DatabaseServer");
        const databaseTables = databaseServer.getTables();
        for (const handbook of this.mydb.templates.handbook.Items) {
            if (!databaseTables.templates.handbook.Items.find((i) => i.Id == handbook.Id))
                databaseTables.templates.handbook.Items.push(handbook);
        }
    }
    addBuffsToDb(container) {
        const databaseServer = container.resolve("DatabaseServer");
        const databaseTables = databaseServer.getTables();
